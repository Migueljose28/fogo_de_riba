...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_imagem_alisson.setStyleSheet("color: rgb(0, 0, 0);\n"
"border-radius: 10px;\n"
"border-style: solid;\n"
"border-width: 5px;\n"
"border-color: rgb(0, 0, 0);")
        ...
        self.label_imagem_ednaldo.setStyleSheet("color: rgb(0, 0, 0);\n"
"border-radius: 10px;\n"
"border-style: solid;\n"
"border-width: 5px;\n"
"border-color: rgb(0, 0, 0);")
        ...
        self.label_imagem_miguel.setStyleSheet("color: rgb(0, 0, 0);\n"
"border-radius: 10px;\n"
"border-style: solid;\n"
"border-width: 5px;\n"
"border-color: rgb(0, 0, 0);")
        ...
        self.label_imagem_rafael.setStyleSheet("color: rgb(0, 0, 0);\n"
"border-radius: 10px;\n"
"border-style: solid;\n"
"border-width: 5px;\n"
"border-color: rgb(0, 0, 0);")
        ...
        self.label_nome_alisson.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
"border-style: solid;\n"
"border-width: 5px;\n"
"border-color: rgb(0, 0, 0);")
        self.label_nome_alisson.setObjectName("label_nome_alisson")
        self.label_nome_ednaldo = QtWidgets.QLabel(self.centralwidget)
        self.label_nome_ednaldo.setGeometry(QtCore.QRect(315, 450, 171, 41))
        self.label_nome_ednaldo.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
"border-style: solid;\n"
"border-width: 5px;\n"
"border-color: rgb(0, 0, 0);")
        self.label_nome_ednaldo.setObjectName("label_nome_ednaldo")
        self.label_nome_miguel = QtWidgets.QLabel(self.centralwidget)
        self.label_nome_miguel.setGeometry(QtCore.QRect(565, 450, 171, 41))
        self.label_nome_miguel.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
"border-style: solid;\n"
"border-width: 5px;\n"
"border-color: rgb(0, 0, 0);")
        self.label_nome_miguel.setObjectName("label_nome_miguel")
        self.label_nome_rafael = QtWidgets.QLabel(self.centralwidget)
        self.label_nome_rafael.setGeometry(QtCore.QRect(815, 450, 171, 41))
        self.label_nome_rafael.setStyleSheet("color: rgb(0, 0, 0);\n"
"background-color: rgb(255, 255, 255);\n"
"border-radius: 10px;\n"
"border-style: solid;\n"
"border-width: 5px;\n"
"border-color: rgb(0, 0, 0);")
        self.label_nome_rafael.setObjectName("label_nome_rafael")
