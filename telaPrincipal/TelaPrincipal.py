...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("Imagens/aboutIcon.jfif"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("Imagens/cardapio2Icon.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"background-color: rgb(255, 255, 255);")
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap("Imagens/leaveIcon.jfif"), QtGui.QIcon.Normal, QtGui.QIcon.On)
...
"background-color: rgb(255, 255, 255);")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("Imagens/cardapioIcon.jfif"), QtGui.QIcon.Normal, QtGui.QIcon.On)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_fundo1.setText(_translate("MainWindow", "<html><head/><body><p><img src=\"Imagens/gaviao.jpg\"/></p></body></html>"))
