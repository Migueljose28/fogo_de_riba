...
"")
        ...
        self.label_cadastro_titulo_cad_clientes.setStyleSheet("BACKGROUND-COLOR: WHITE;\n"
"font: 75 8pt \"Verdana\";\n"
"")
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_titulo_fixo.setGeometry(QtCore.QRect(0, 10, 381, 61))
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_subtitulo_fixo.setGeometry(QtCore.QRect(90, 50, 211, 21))
        ...
        self.label_base_imagem_fixa = QtWidgets.QLabel(self.centralwidget)
        self.label_base_imagem_fixa.setGeometry(QtCore.QRect(46, 130, 301, 241))
        self.label_base_imagem_fixa.setStyleSheet("background-color: rgb(0, 0, 0);")
        self.label_base_imagem_fixa.setText("")
        self.label_base_imagem_fixa.setObjectName("label_base_imagem_fixa")
        self.label_imagem_fixa = QtWidgets.QLabel(self.centralwidget)
        self.label_imagem_fixa.setGeometry(QtCore.QRect(60, 150, 271, 201))
        self.label_imagem_fixa.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.label_imagem_fixa.setText("")
        self.label_imagem_fixa.setPixmap(QtGui.QPixmap("/tmp/projeto final/xilo_comidas.jpg"))
        ...
        self.label_descricao_fixa.setGeometry(QtCore.QRect(0, 410, 391, 31))
        ...
        self.widget_login.setGeometry(QtCore.QRect(400, -10, 401, 621))
        ...
        self.label_login_titulo_clientes.setGeometry(QtCore.QRect(0, 100, 411, 51))
        self.label_login_titulo_clientes.setStyleSheet("BACKGROUND-COLOR: WHITE;\n"
"font: 75 8pt \"Verdana\";\n"
"")
...
"background-color: rgb(255, 255, 255);")
        ...
        self.label_login_usuario.setGeometry(QtCore.QRect(70, 230, 81, 31))
...
"")
        ...
        self.lineEdit_login_usuario.setGeometry(QtCore.QRect(160, 230, 181, 41))
...
"padding: 5px;")
        ...
        self.label_login_senha.setGeometry(QtCore.QRect(90, 300, 61, 31))
...
"")
        ...
        self.lineEdit_login_senha.setGeometry(QtCore.QRect(160, 300, 181, 41))
...
"padding: 5px;")
        ...
        self.pushButton_login_logar.setGeometry(QtCore.QRect(150, 390, 111, 41))
...
"")
        ...
        self.pushButton_login_crie.clicked.connect(self.transparencia1) # type: ignore
        self.pushButton_cadastro_entre.clicked.connect(self.transparencia2) # type: ignore
        self.pushButton_login_crie.clicked.connect(self.transparencia4)  # type: ignore
        self.pushButton_cadastro_entre.clicked.connect(self.transparencia3)  # type: ignore
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_cadastro_titulo_cad_clientes.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600; color:#000000;\">CRIE SUA CONTA</span></p></body></html>"))
        ...
        self.label_titulo_fixo.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:16pt; font-weight:600; color:#000000;\">RESTAURANTE FOGO DE RIBA</span></p></body></html>"))
        self.label_subtitulo_fixo.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600;\">Fogo de Riba no Fogão, Calor no Coração</span></p></body></html>"))
        ...
        self.label_login_titulo_clientes.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:600; color:#000000;\">ACESSE SUA CONTA</span></p></body></html>"))
